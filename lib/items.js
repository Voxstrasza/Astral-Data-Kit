...
function toEditor(row, icon, socketBonusText, spellText, factionName)
{
    const stats = [];
    const effects = [];
...
module.exports = {
    ItemDisplay, ItemSets, Factions, toEditor, toResult, categoryOf, editorLines, budgetStats, equipped, inventoryTypeFor, slotTypes, slotNames, slotNameTable, ARMORY_SLOTS, CURRENCY_CLASS, MATERIAL_CLASS, MOUNT_CLASS, SLOTS, ARMOR_TYPES, WEAPON_TYPES, PRIMARY_STATS,
