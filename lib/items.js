...
{
    const gear = { stats: {}, armor: 0, resistances: {} };
...
module.exports = {
    ItemDisplay, toEditor, toResult, categoryOf, editorLines, budgetStats, equipped, inventoryTypeFor, slotTypes, slotNames, slotNameTable, ARMORY_SLOTS, CURRENCY_CLASS, MATERIAL_CLASS, MOUNT_CLASS, SLOTS, ARMOR_TYPES, WEAPON_TYPES, PRIMARY_STATS,
