...
const MEMBERS = {
    /*
     * Blackrock Depths - the Ring of Law spawns one of six arena bosses, decided per run.
     * instance_encounters credits a single creature, which is five sixths of an answer; the pool
     * is what the arena can actually give you.
     */
    '230|ringoflaw': [9027, 9028, 9029, 9030, 9031, 9032],

    /*
     * Karazhan - the Opera Event runs one of three shows. Only the creatures that finish a show
     * carry loot: the Wizard of Oz pays out through the Crone, and Romulo and Julianne have a
     * table each because either can be the last one standing.
     */
    '532|operaevent': [18168, 17521, 17533, 17534],

    /*
     * Temple of Ahn'Qiraj - the bug trio. The DBC calls the encounter Silithid Royalty and
     * instance_encounters credits one of them, which is two names short of the fight.
     */
    '531|silithidroyalty': [15511, 15543, 15544],

    /*
     * Black Temple - the Illidari Council. instance_encounters credits creature 23426, the
     * controller that runs the fight, and it has no loot table at all: every drop is on one of
     * the four it controls.
     */
    '564|theillidaricouncil': [22949, 22950, 22951, 22952],
...
const RENAMES = {
    ...
    '603|theironcouncil': 'Assembly of Iron',
